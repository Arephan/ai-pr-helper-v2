 ...
 */
function c(text: string, ...colorCodes: string[]): string {
 ...
 */
export function formatReviewResultText(result: ReviewResult): string {
  const lines: string[] = [];
 ...
 */
function formatFileAnalysisText(file: FileAnalysis): string {
  const lines: string[] = [];
 ...
 */
function formatHunkAnalysisText(hunk: HunkAnalysis, index: number): string {
  const lines: string[] = [];
 ...
 */
function formatSummaryText(summary: SummaryAnalysis): string {
  const lines: string[] = [];
 ...
 */
function formatPatternsText(patterns: PatternAnalysis): string {
  const lines: string[] = [];
 ...
 */
function formatComplexityText(complexity: ComplexityAnalysis): string {
  const lines: string[] = [];
...
function formatPatternTypeText(type: string): string {
...
function formatMetricNameText(metric: string): string {
  const labels: Record<string, string> = {
...
function formatLikelihoodText(likelihood: string): string {
  switch (likelihood) {
